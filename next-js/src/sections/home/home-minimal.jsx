...
export function HomeMinimal({ sx, ...other }) {
  const renderDescription = () => (
    <>
      <SectionTitle
        caption="Computing Success"
        title="What is"
        txtGradient="GridFORCE?"
    ...
    >
      ...
      >
        <Box
          component="img"
          alt="Home chart"
          src={`${CONFIG.assetsDir}/assets/images/home/screen.png`}
          sx={{ width: 720 }}
        />
      </Box>
    </Stack>
...
const ITEMS = [
  {
    ...
    description: 'A marketplace for connecting providers and consumers',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-design.svg`,
    title: 'Intuitive Design',
    description: 'GridForce is designed to be intuitive and easy to use.',
  },
  {
    icon: `${CONFIG.assetsDir}/assets/icons/home/ic-development.svg`,
    title: 'Development',
    description: 'Easy to upload, observe, and optimize models.',
  },
];
